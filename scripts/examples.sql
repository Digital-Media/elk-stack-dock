...
insert into visit ( idvisit, ip_address, timestamp, user_iduser) values
(1, '10.28.14.123', NOW(), 1),
(2, '10.28.14.124', NOW(), 2),
(3, '10.28.14.123', NOW(), 1),
(4, '10.28.14.123', NOW(), 2),
(5, '10.28.14.125', NOW(), null);
